...
class LangGuess {
  ...
  static const Map<String, Set<String>> _words = {
    'pl': {
      ...
      'nie', 'jest', 'się', 'to', 'na', 'co', 'jak', 'tak', 'czy', 'do', 'ja', 'ty', 'gdzie', 'kiedy',
      'ale', 'i', 'a', 'w', 'z', 'ze', 'o', 'od', 'po', 'za', 'przy', 'pod', 'nad', 'bez', 'dla', 'przez',
      'że', 'żeby', 'bo', 'lub', 'albo', 'ani', 'więc', 'też', 'także', 'tylko', 'już', 'jeszcze', 'teraz',
      'tu', 'tutaj', 'tam', 'ten', 'ta', 'te', 'tego', 'tej', 'tym', 'tych', 'ci', 'on', 'ona', 'ono',
      'oni', 'one', 'my', 'wy', 'mnie', 'mi', 'mną', 'ciebie', 'cię', 'tobie', 'jego', 'go', 'jej', 'ją',
      'nam', 'nas', 'was', 'wam', 'ich', 'im', 'mój', 'moja', 'moje', 'twój', 'twoja', 'twoje', 'nasz',
      'nasza', 'nasze', 'swój', 'swoja', 'swoje', 'jaki', 'jaka', 'jakie', 'który', 'która', 'które',
      'kto', 'kogo', 'komu', 'czego', 'czemu', 'dlaczego', 'ile', 'kiedyś', 'zawsze', 'nigdy', 'często',
      'chyba', 'może', 'pewnie', 'jasne', 'oczywiście', 'naprawdę', 'niestety', 'właśnie', 'jednak',
      // being / having / wanting
      'jestem', 'jesteś', 'jesteśmy', 'jesteście', 'są', 'był', 'była', 'było', 'byli', 'były', 'będzie',
      'będę', 'będziesz', 'będziemy', 'mam', 'masz', 'ma', 'mamy', 'macie', 'mają', 'miał', 'miała',
      'chcę', 'chcesz', 'chce', 'chcemy', 'chcą', 'chciałbym', 'chciałabym', 'mogę', 'możesz', 'może',
      'możemy', 'muszę', 'musisz', 'musi', 'trzeba', 'można', 'wiem', 'wiesz', 'wie', 'lubię', 'lubisz',
      'myślę', 'myślisz', 'widzę', 'widzisz', 'słyszę', 'rozumiem', 'rozumiesz', 'proszę', 'dziękuję',
      'przepraszam', 'idę', 'idziesz', 'idziemy', 'jadę', 'jedziemy', 'kupić', 'kupię', 'zrobić', 'robię',
      'powiedzieć', 'mówię', 'mówisz', 'mówi', 'mieszkam', 'mieszkasz', 'mieszka', 'pracuję', 'pracuje',
      'nazywam', 'nazywasz', 'poproszę', 'daj', 'dajcie', 'zapraszam', 'chodź', 'zobacz', 'słuchaj',
      // everyday nouns & adjectives
      'dzień', 'dobry', 'dobra', 'dobre', 'dobrze', 'źle', 'bardzo', 'trochę', 'dużo', 'mało', 'nowy',
      'nowa', 'nowe', 'stary', 'stara', 'stare', 'duży', 'duża', 'duże', 'mały', 'mała', 'małe', 'piękny',
      'piękna', 'ładny', 'ładna', 'drogi', 'droga', 'tani', 'tania', 'ciepły', 'zimny', 'gorący',
      'czas', 'dzisiaj', 'dziś', 'jutro', 'wczoraj', 'rano', 'wieczór', 'wieczorem', 'noc', 'tydzień',
      'miesiąc', 'rok', 'lata', 'godzina', 'minuta', 'dni', 'dwa', 'trzy', 'cztery', 'pięć', 'dziesięć',
      'człowiek', 'ludzie', 'kobieta', 'mężczyzna', 'pan', 'pani', 'dziecko', 'dzieci', 'rodzina',
      'mama', 'tata', 'syn', 'córka', 'brat', 'siostra', 'żona', 'mąż', 'przyjaciel', 'kolega',
      'dom', 'domu', 'mieszkanie', 'praca', 'pracy', 'szkoła', 'sklep', 'sklepu', 'miasto', 'ulica',
      'droga', 'samochód', 'auto', 'pociąg', 'autobus', 'lotnisko', 'dworzec', 'bilet', 'hotel', 'pokój',
      'pieniądze', 'złoty', 'złotych', 'cena', 'rachunek', 'woda', 'piwo', 'kawa', 'herbata', 'jedzenie',
      'chleb', 'mięso', 'ryba', 'zupa', 'obiad', 'śniadanie', 'kolacja', 'restauracja', 'toaleta',
      'wojna', 'pokój', 'kraj', 'polska', 'polski', 'polsku', 'angielski', 'angielsku', 'język',
      'cebula', 'ziemniaki', 'jabłko', 'lekarz', 'szpital', 'apteka', 'pomoc', 'pomocy', 'problem',
      'wszystko', 'nic', 'coś', 'ktoś', 'nikt', 'każdy', 'inny', 'sam', 'sama', 'razem', 'szkoda',
      'zdrowie', 'zdrowia', 'święta', 'urodziny', 'prezent', 'zdjęcie', 'telefon', 'numer', 'adres',
    },
